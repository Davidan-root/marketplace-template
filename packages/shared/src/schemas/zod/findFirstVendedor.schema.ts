...
export const VendedorFindFirstSelectSchema: z.ZodType<Prisma.VendedorSelect> = z.object({
...
export const VendedorFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    nombreTienda: z.boolean().optional(),
    reputacion: z.boolean().optional(),
    usuarioId: z.boolean().optional(),
...
export const VendedorFindFirstSchema: z.ZodType<Prisma.VendedorFindFirstArgs> = z.object({ select: VendedorFindFirstSelectSchema.optional(), include: z.lazy(() => VendedorIncludeObjectSchema.optional()), orderBy: z.union([VendedorOrderByWithRelationInputObjectSchema, VendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendedorWhereInputObjectSchema.optional(), cursor: VendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendedorScalarFieldEnumSchema, VendedorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VendedorFindFirstArgs>;

export const VendedorFindFirstZodSchema = z.object({ select: VendedorFindFirstSelectSchema.optional(), include: z.lazy(() => VendedorIncludeObjectSchema.optional()), orderBy: z.union([VendedorOrderByWithRelationInputObjectSchema, VendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendedorWhereInputObjectSchema.optional(), cursor: VendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendedorScalarFieldEnumSchema, VendedorScalarFieldEnumSchema.array()]).optional() }).strict();