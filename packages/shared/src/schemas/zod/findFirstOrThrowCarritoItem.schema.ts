...
export const CarritoItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CarritoItemSelect> = z.object({
...
export const CarritoItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cantidadCI: z.boolean().optional(),
    carritoId: z.boolean().optional(),
    carrito: z.boolean().optional(),
