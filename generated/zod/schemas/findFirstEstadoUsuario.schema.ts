...
export const EstadoUsuarioFindFirstSelectSchema: z.ZodType<Prisma.EstadoUsuarioSelect> = z.object({
...
export const EstadoUsuarioFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    descripcionEU: z.boolean().optional(),
    nombreEU: z.boolean().optional(),
    usuarios: z.boolean().optional(),
...
export const EstadoUsuarioFindFirstSchema: z.ZodType<Prisma.EstadoUsuarioFindFirstArgs> = z.object({ select: EstadoUsuarioFindFirstSelectSchema.optional(), include: z.lazy(() => EstadoUsuarioIncludeObjectSchema.optional()), orderBy: z.union([EstadoUsuarioOrderByWithRelationInputObjectSchema, EstadoUsuarioOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoUsuarioWhereInputObjectSchema.optional(), cursor: EstadoUsuarioWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoUsuarioScalarFieldEnumSchema, EstadoUsuarioScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EstadoUsuarioFindFirstArgs>;

export const EstadoUsuarioFindFirstZodSchema = z.object({ select: EstadoUsuarioFindFirstSelectSchema.optional(), include: z.lazy(() => EstadoUsuarioIncludeObjectSchema.optional()), orderBy: z.union([EstadoUsuarioOrderByWithRelationInputObjectSchema, EstadoUsuarioOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoUsuarioWhereInputObjectSchema.optional(), cursor: EstadoUsuarioWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoUsuarioScalarFieldEnumSchema, EstadoUsuarioScalarFieldEnumSchema.array()]).optional() }).strict();