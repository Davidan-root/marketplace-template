...
export const PedidoItemFindFirstSelectSchema: z.ZodType<Prisma.PedidoItemSelect> = z.object({
...
export const PedidoItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cantidadPI: z.boolean().optional(),
    precioUnitario: z.boolean().optional(),
    subtotalPI: z.boolean().optional(),
