...
export const PedidoItemFindManySelectSchema: z.ZodType<Prisma.PedidoItemSelect> = z.object({
...
export const PedidoItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    cantidadPI: z.boolean().optional(),
    precioUnitario: z.boolean().optional(),
    subtotalPI: z.boolean().optional(),
...
export const PedidoItemFindManySchema: z.ZodType<Prisma.PedidoItemFindManyArgs> = z.object({ select: PedidoItemFindManySelectSchema.optional(), include: z.lazy(() => PedidoItemIncludeObjectSchema.optional()), orderBy: z.union([PedidoItemOrderByWithRelationInputObjectSchema, PedidoItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoItemWhereInputObjectSchema.optional(), cursor: PedidoItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoItemScalarFieldEnumSchema, PedidoItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PedidoItemFindManyArgs>;

export const PedidoItemFindManyZodSchema = z.object({ select: PedidoItemFindManySelectSchema.optional(), include: z.lazy(() => PedidoItemIncludeObjectSchema.optional()), orderBy: z.union([PedidoItemOrderByWithRelationInputObjectSchema, PedidoItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoItemWhereInputObjectSchema.optional(), cursor: PedidoItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoItemScalarFieldEnumSchema, PedidoItemScalarFieldEnumSchema.array()]).optional() }).strict();