...
export const PublicacionFindManySelectSchema: z.ZodType<Prisma.PublicacionSelect> = z.object({
...
export const PublicacionFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    condicionesVenta: z.boolean().optional(),
    enviosVenta: z.boolean().optional(),
    precioVenta: z.boolean().optional(),
