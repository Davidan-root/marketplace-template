...
export const ResenaFindFirstSelectSchema: z.ZodType<Prisma.ResenaSelect> = z.object({
...
export const ResenaFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    comentario: z.boolean().optional(),
    fechaHoraAlta: z.boolean().optional(),
    puntaje: z.boolean().optional(),
...
export const ResenaFindFirstSchema: z.ZodType<Prisma.ResenaFindFirstArgs> = z.object({ select: ResenaFindFirstSelectSchema.optional(), include: z.lazy(() => ResenaIncludeObjectSchema.optional()), orderBy: z.union([ResenaOrderByWithRelationInputObjectSchema, ResenaOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResenaWhereInputObjectSchema.optional(), cursor: ResenaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResenaScalarFieldEnumSchema, ResenaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResenaFindFirstArgs>;

export const ResenaFindFirstZodSchema = z.object({ select: ResenaFindFirstSelectSchema.optional(), include: z.lazy(() => ResenaIncludeObjectSchema.optional()), orderBy: z.union([ResenaOrderByWithRelationInputObjectSchema, ResenaOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResenaWhereInputObjectSchema.optional(), cursor: ResenaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResenaScalarFieldEnumSchema, ResenaScalarFieldEnumSchema.array()]).optional() }).strict();