...
export const CategoriaFindFirstSelectSchema: z.ZodType<Prisma.CategoriaSelect> = z.object({
...
export const CategoriaFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    descripcionCategoria: z.boolean().optional(),
    nombreCategoria: z.boolean().optional(),
    productos: z.boolean().optional(),
...
export const CategoriaFindFirstSchema: z.ZodType<Prisma.CategoriaFindFirstArgs> = z.object({ select: CategoriaFindFirstSelectSchema.optional(), include: z.lazy(() => CategoriaIncludeObjectSchema.optional()), orderBy: z.union([CategoriaOrderByWithRelationInputObjectSchema, CategoriaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CategoriaWhereInputObjectSchema.optional(), cursor: CategoriaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CategoriaScalarFieldEnumSchema, CategoriaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CategoriaFindFirstArgs>;

export const CategoriaFindFirstZodSchema = z.object({ select: CategoriaFindFirstSelectSchema.optional(), include: z.lazy(() => CategoriaIncludeObjectSchema.optional()), orderBy: z.union([CategoriaOrderByWithRelationInputObjectSchema, CategoriaOrderByWithRelationInputObjectSchema.array()]).optional(), where: CategoriaWhereInputObjectSchema.optional(), cursor: CategoriaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CategoriaScalarFieldEnumSchema, CategoriaScalarFieldEnumSchema.array()]).optional() }).strict();