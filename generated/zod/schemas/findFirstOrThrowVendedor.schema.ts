...
export const VendedorFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VendedorSelect> = z.object({
...
export const VendedorFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    nombreTienda: z.boolean().optional(),
    reputacion: z.boolean().optional(),
    usuarioId: z.boolean().optional(),
...
export const VendedorFindFirstOrThrowSchema: z.ZodType<Prisma.VendedorFindFirstOrThrowArgs> = z.object({ select: VendedorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VendedorIncludeObjectSchema.optional()), orderBy: z.union([VendedorOrderByWithRelationInputObjectSchema, VendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendedorWhereInputObjectSchema.optional(), cursor: VendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendedorScalarFieldEnumSchema, VendedorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VendedorFindFirstOrThrowArgs>;

export const VendedorFindFirstOrThrowZodSchema = z.object({ select: VendedorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VendedorIncludeObjectSchema.optional()), orderBy: z.union([VendedorOrderByWithRelationInputObjectSchema, VendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendedorWhereInputObjectSchema.optional(), cursor: VendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendedorScalarFieldEnumSchema, VendedorScalarFieldEnumSchema.array()]).optional() }).strict();