...
export const PagoFindManySelectSchema: z.ZodType<Prisma.PagoSelect> = z.object({
...
export const PagoFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    metodoPago: z.boolean().optional(),
    monto: z.boolean().optional(),
    pedidoId: z.boolean().optional(),
...
export const PagoFindManySchema: z.ZodType<Prisma.PagoFindManyArgs> = z.object({ select: PagoFindManySelectSchema.optional(), include: z.lazy(() => PagoIncludeObjectSchema.optional()), orderBy: z.union([PagoOrderByWithRelationInputObjectSchema, PagoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PagoWhereInputObjectSchema.optional(), cursor: PagoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PagoScalarFieldEnumSchema, PagoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PagoFindManyArgs>;

export const PagoFindManyZodSchema = z.object({ select: PagoFindManySelectSchema.optional(), include: z.lazy(() => PagoIncludeObjectSchema.optional()), orderBy: z.union([PagoOrderByWithRelationInputObjectSchema, PagoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PagoWhereInputObjectSchema.optional(), cursor: PagoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PagoScalarFieldEnumSchema, PagoScalarFieldEnumSchema.array()]).optional() }).strict();