...
export const PedidoFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PedidoSelect> = z.object({
...
export const PedidoFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    fechaHoraAlta: z.boolean().optional(),
    numeroPedido: z.boolean().optional(),
    totalPrecio: z.boolean().optional(),
...
export const PedidoFindFirstOrThrowSchema: z.ZodType<Prisma.PedidoFindFirstOrThrowArgs> = z.object({ select: PedidoFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PedidoIncludeObjectSchema.optional()), orderBy: z.union([PedidoOrderByWithRelationInputObjectSchema, PedidoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoWhereInputObjectSchema.optional(), cursor: PedidoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoScalarFieldEnumSchema, PedidoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PedidoFindFirstOrThrowArgs>;

export const PedidoFindFirstOrThrowZodSchema = z.object({ select: PedidoFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PedidoIncludeObjectSchema.optional()), orderBy: z.union([PedidoOrderByWithRelationInputObjectSchema, PedidoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoWhereInputObjectSchema.optional(), cursor: PedidoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoScalarFieldEnumSchema, PedidoScalarFieldEnumSchema.array()]).optional() }).strict();