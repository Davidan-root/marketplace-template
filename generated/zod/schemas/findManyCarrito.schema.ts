...
export const CarritoFindManySelectSchema: z.ZodType<Prisma.CarritoSelect> = z.object({
...
export const CarritoFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    fechaHoraAlta: z.boolean().optional(),
    fechaHoraBaja: z.boolean().optional(),
    fechaHoraModificacion: z.boolean().optional(),
...
export const CarritoFindManySchema: z.ZodType<Prisma.CarritoFindManyArgs> = z.object({ select: CarritoFindManySelectSchema.optional(), include: z.lazy(() => CarritoIncludeObjectSchema.optional()), orderBy: z.union([CarritoOrderByWithRelationInputObjectSchema, CarritoOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoWhereInputObjectSchema.optional(), cursor: CarritoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoScalarFieldEnumSchema, CarritoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarritoFindManyArgs>;

export const CarritoFindManyZodSchema = z.object({ select: CarritoFindManySelectSchema.optional(), include: z.lazy(() => CarritoIncludeObjectSchema.optional()), orderBy: z.union([CarritoOrderByWithRelationInputObjectSchema, CarritoOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoWhereInputObjectSchema.optional(), cursor: CarritoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoScalarFieldEnumSchema, CarritoScalarFieldEnumSchema.array()]).optional() }).strict();