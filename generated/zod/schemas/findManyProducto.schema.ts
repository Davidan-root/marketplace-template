...
export const ProductoFindManySelectSchema: z.ZodType<Prisma.ProductoSelect> = z.object({
...
export const ProductoFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    descripcionProducto: z.boolean().optional(),
    nombreProducto: z.boolean().optional(),
    categoriaId: z.boolean().optional(),
