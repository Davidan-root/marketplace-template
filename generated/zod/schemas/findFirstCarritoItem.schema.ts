...
export const CarritoItemFindFirstSelectSchema: z.ZodType<Prisma.CarritoItemSelect> = z.object({
...
export const CarritoItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    cantidadCI: z.boolean().optional(),
    carritoId: z.boolean().optional(),
    carrito: z.boolean().optional(),
...
export const CarritoItemFindFirstSchema: z.ZodType<Prisma.CarritoItemFindFirstArgs> = z.object({ select: CarritoItemFindFirstSelectSchema.optional(), include: z.lazy(() => CarritoItemIncludeObjectSchema.optional()), orderBy: z.union([CarritoItemOrderByWithRelationInputObjectSchema, CarritoItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoItemWhereInputObjectSchema.optional(), cursor: CarritoItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoItemScalarFieldEnumSchema, CarritoItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarritoItemFindFirstArgs>;

export const CarritoItemFindFirstZodSchema = z.object({ select: CarritoItemFindFirstSelectSchema.optional(), include: z.lazy(() => CarritoItemIncludeObjectSchema.optional()), orderBy: z.union([CarritoItemOrderByWithRelationInputObjectSchema, CarritoItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoItemWhereInputObjectSchema.optional(), cursor: CarritoItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoItemScalarFieldEnumSchema, CarritoItemScalarFieldEnumSchema.array()]).optional() }).strict();