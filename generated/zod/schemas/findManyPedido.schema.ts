...
export const PedidoFindManySelectSchema: z.ZodType<Prisma.PedidoSelect> = z.object({
...
export const PedidoFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    fechaHoraAlta: z.boolean().optional(),
    numeroPedido: z.boolean().optional(),
    totalPrecio: z.boolean().optional(),
...
export const PedidoFindManySchema: z.ZodType<Prisma.PedidoFindManyArgs> = z.object({ select: PedidoFindManySelectSchema.optional(), include: z.lazy(() => PedidoIncludeObjectSchema.optional()), orderBy: z.union([PedidoOrderByWithRelationInputObjectSchema, PedidoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoWhereInputObjectSchema.optional(), cursor: PedidoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoScalarFieldEnumSchema, PedidoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PedidoFindManyArgs>;

export const PedidoFindManyZodSchema = z.object({ select: PedidoFindManySelectSchema.optional(), include: z.lazy(() => PedidoIncludeObjectSchema.optional()), orderBy: z.union([PedidoOrderByWithRelationInputObjectSchema, PedidoOrderByWithRelationInputObjectSchema.array()]).optional(), where: PedidoWhereInputObjectSchema.optional(), cursor: PedidoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PedidoScalarFieldEnumSchema, PedidoScalarFieldEnumSchema.array()]).optional() }).strict();