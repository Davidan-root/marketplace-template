...
export const CarritoFindFirstSelectSchema: z.ZodType<Prisma.CarritoSelect> = z.object({
...
export const CarritoFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    fechaHoraAlta: z.boolean().optional(),
    fechaHoraBaja: z.boolean().optional(),
    fechaHoraModificacion: z.boolean().optional(),
...
export const CarritoFindFirstSchema: z.ZodType<Prisma.CarritoFindFirstArgs> = z.object({ select: CarritoFindFirstSelectSchema.optional(), include: z.lazy(() => CarritoIncludeObjectSchema.optional()), orderBy: z.union([CarritoOrderByWithRelationInputObjectSchema, CarritoOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoWhereInputObjectSchema.optional(), cursor: CarritoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoScalarFieldEnumSchema, CarritoScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CarritoFindFirstArgs>;

export const CarritoFindFirstZodSchema = z.object({ select: CarritoFindFirstSelectSchema.optional(), include: z.lazy(() => CarritoIncludeObjectSchema.optional()), orderBy: z.union([CarritoOrderByWithRelationInputObjectSchema, CarritoOrderByWithRelationInputObjectSchema.array()]).optional(), where: CarritoWhereInputObjectSchema.optional(), cursor: CarritoWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CarritoScalarFieldEnumSchema, CarritoScalarFieldEnumSchema.array()]).optional() }).strict();