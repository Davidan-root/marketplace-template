...
export const EstadoUsuarioFindManySelectSchema: z.ZodType<Prisma.EstadoUsuarioSelect> = z.object({
...
export const EstadoUsuarioFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    descripcionEU: z.boolean().optional(),
    nombreEU: z.boolean().optional(),
    usuarios: z.boolean().optional(),
...
export const EstadoUsuarioFindManySchema: z.ZodType<Prisma.EstadoUsuarioFindManyArgs> = z.object({ select: EstadoUsuarioFindManySelectSchema.optional(), include: z.lazy(() => EstadoUsuarioIncludeObjectSchema.optional()), orderBy: z.union([EstadoUsuarioOrderByWithRelationInputObjectSchema, EstadoUsuarioOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoUsuarioWhereInputObjectSchema.optional(), cursor: EstadoUsuarioWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoUsuarioScalarFieldEnumSchema, EstadoUsuarioScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EstadoUsuarioFindManyArgs>;

export const EstadoUsuarioFindManyZodSchema = z.object({ select: EstadoUsuarioFindManySelectSchema.optional(), include: z.lazy(() => EstadoUsuarioIncludeObjectSchema.optional()), orderBy: z.union([EstadoUsuarioOrderByWithRelationInputObjectSchema, EstadoUsuarioOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoUsuarioWhereInputObjectSchema.optional(), cursor: EstadoUsuarioWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoUsuarioScalarFieldEnumSchema, EstadoUsuarioScalarFieldEnumSchema.array()]).optional() }).strict();