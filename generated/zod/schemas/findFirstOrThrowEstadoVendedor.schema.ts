...
export const EstadoVendedorFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EstadoVendedorSelect> = z.object({
...
export const EstadoVendedorFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    descripcionEV: z.boolean().optional(),
    nombreEV: z.boolean().optional(),
    vendedores: z.boolean().optional(),
...
export const EstadoVendedorFindFirstOrThrowSchema: z.ZodType<Prisma.EstadoVendedorFindFirstOrThrowArgs> = z.object({ select: EstadoVendedorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EstadoVendedorIncludeObjectSchema.optional()), orderBy: z.union([EstadoVendedorOrderByWithRelationInputObjectSchema, EstadoVendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoVendedorWhereInputObjectSchema.optional(), cursor: EstadoVendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoVendedorScalarFieldEnumSchema, EstadoVendedorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EstadoVendedorFindFirstOrThrowArgs>;

export const EstadoVendedorFindFirstOrThrowZodSchema = z.object({ select: EstadoVendedorFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EstadoVendedorIncludeObjectSchema.optional()), orderBy: z.union([EstadoVendedorOrderByWithRelationInputObjectSchema, EstadoVendedorOrderByWithRelationInputObjectSchema.array()]).optional(), where: EstadoVendedorWhereInputObjectSchema.optional(), cursor: EstadoVendedorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EstadoVendedorScalarFieldEnumSchema, EstadoVendedorScalarFieldEnumSchema.array()]).optional() }).strict();